...
def main():
    ...
    while(run):
        ...
        #spraw dzenie czy waz zjada jablkod
        ...
        tekst=czcionka.render("Gracz1 punkty: {0}".format(obiektWaz1.punkty),1,(0,255,0))
        tekst2=czcionka.render("Gracz2 punkty: {0}".format(obiektWaz2.punkty),1,(0,255,0))
